...
class NoteViewModel @ViewModelInject constructor(
    ...
    fun saveNote() {
        ...
        if (this::noteDetail.isInitialized) {
            viewModelScope.launch {
                createNoteUseCase.execute(uiNoteMapper.toDTOModel(noteDetail, userLog!!))
            }
        }
    ...
    fun updateNote() {
        ...
        viewModelScope.launch {
            noteDetail.uuid?.let {
                updateNoteTaskUseCase.execute(uiNoteMapper.toDTOModel(noteDetail, userLog!!))
            }
        }
    }
